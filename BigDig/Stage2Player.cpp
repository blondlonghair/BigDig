...
void Stage2Player::OnRender()
{
}

void Stage2Player::OnDestroy()
{
}

void Stage2Player::OnCollisionEnter(CObject* _pObj)
{
...
void Stage2Player::OnCollisionStay(CObject* _pObj)
{
}
...
void Stage2Player::Move()
{
	...
	if (moveRot == MoveRot::Up && GAME.m_Stage2Tile[xTemp][yTemp] != 1 && MoveCheck2())
	{
	...
	else if (moveRot == MoveRot::Down && GAME.m_Stage2Tile[xTemp][yTemp] != 1 && MoveCheck2())
	{
		for (int i = 0; i < moveSpeed - 1; i++)
		{
			tf->m_vPos += Vec2(0, 1);
	...
	else if (moveRot == MoveRot::Left && GAME.m_Stage2Tile[xTemp][yTemp] != 1 && MoveCheck2())
	{
		for (int i = 0; i < moveSpeed - 1; i++)
		{
			tf->m_vPos += Vec2(-1, 0);
	...
	else if (moveRot == MoveRot::Right && GAME.m_Stage2Tile[xTemp][yTemp] != 1 && MoveCheck2())
	{
		for (int i = 0; i < moveSpeed - 1; i++)
		{
			tf->m_vPos += Vec2(1, 0);
